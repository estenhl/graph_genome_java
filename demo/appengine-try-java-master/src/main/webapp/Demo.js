var Demo = React.createClass({
	...
	render: function () {
		...
		return (
			<table
				style={{backgroundColor: "lightblue", margin: "10px", marginTop: "30px", borderRadius: "10px", width: "99%"}}>
				<tr>
					...
					<table style={{padding: "5px"}}>
						<tr>
							<td style={{border: "1px solid black", width: "30%"}}>
								(DISCLAIMER: This is a very small demo of the tool found in
								https://github.com/estenpro/graph_genome_java. For larger sequences and more flexibility follow the
								download and execute instructions for the command line tool)<br />
								<br />
								{inputSequences}
								<br />
								<br />
								...
								{alignmentSequence}
								<br />
								<font color="red">(IMPORTANT DISCLAIMER: In order to achieve "expected" results, this parameter must be
									set to atleast the smallest edit distance between the strings)</font><br />
